...
class Email extends Component{
    ...
    render(){
        ...
        return(
            <div className='container-body-email'>

                    
            
                    <h1 className='titre'>Fake E-mail Sender Project</h1>
                    ...
                    <div class="col-12">
                        <label for="inputAddress" class="form-label">Empfänger-E-Mail-Adresse</label>
                    ...
                    <p className="text-email"  >React.js / Python / Flask / HTML / CSS / Bootstrap</p>
